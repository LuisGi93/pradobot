...
class EncargadoMensajesGrupales
  def initialize # se puede meter aqui lo relacionado con accion_chat si solamente se van a llamar funciones en los hijos de accion_chat
    @grupos = {} # ! tienen que ser instanciadas las actuadores_sobre_mensajes asociadas a los chats privados/menus ya que suelen tener estado interno, otra cosa es que se pueda hacer una jearquia
  end
